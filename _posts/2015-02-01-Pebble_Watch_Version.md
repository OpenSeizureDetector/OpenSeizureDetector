...
excerpt: Working prototype of an accelerometer based seizure detector using a Pebble Smart Watch and associated Android mobile phone.
...
someone is having a tonic-clonic epileptic seizure after our son Benjamin had a particularly nasty one a couple of years ago, and we only noticed it because one of us looked up at the video monitor that we have to help us keep an eye on him - see [http://openseizuredetector.org.uk](http://openseizuredetector.org.uk) for more information.
...
<img class="img_med" style="width:600px;" src="https://raw.githubusercontent.com/jones139/OpenSeizureDetector/master/pebble_version/Documentation/diagram.jpg">
